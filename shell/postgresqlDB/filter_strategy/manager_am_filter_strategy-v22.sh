...
insert(){
    # 方式一:
    # 这里输入的时间格式为:2020-01-01\ 00:00:00,也就是把中间的空格转义,是可以的
    ...
    # 方式二:
    # 上面的方式一,是可以的;当然了也可以手动修改IFS的值,也就是把read的分隔符进行修改,具体如下:
    # 此时输入的值为: sourceid#vim001#2020-02-02 00:00:00#2020-05-05 00:00:00
    OIFS="${IFS}"
    IFS="#"   # change ifs
    echo 'input value: type(sourceid/neuid)  value  start_time end_time (time format:"2020-01-01 00:00:00")'
